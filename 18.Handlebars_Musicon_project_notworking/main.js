...
//variable with an access to html element- template
const templateElement = document.getElementById('templateHB');
//getting the HTML markup contained within template above
const templateSource = templateElement.innerHTML;
//compiling a template
const template = Handlebars.compile(templateSource);

//above returns a function to the template
//template will accept an object and use the properties
//of the object to fill in a Handlebars template
const compiledHtml = template(context);
//the returned value is a string of HTML with 
//a filled out template

//rendering the compiled HTML in the browser
const displayInfo = document.getElementById('information');
displayInfo.innerHTML= compiledHTML;